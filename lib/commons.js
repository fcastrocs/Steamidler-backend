...
const SteamGuardError = [
    "AccountLogonDenied",
    "AccountLoginDeniedNeedTwoFactor",
];
const BadSteamGuardCode = [
...
export const isAuthError = (error) => isSteamGuardError(error) ||
...
export function isIntArray(variable) {
    // must be an array
...
export function setCookie(name, value, res) {
    // expires in 10 years
    const date = new Date();
